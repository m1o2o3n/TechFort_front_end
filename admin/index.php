...
// 判断用户是否登录一定是最先去做
// tech_get_current_user();

// 获取界面所需要的数据
// 重复的操作一定封装起来
// $posts_count = tech_fetch_one('select count(1) as num from posts;')['num'];

// $categories_count = tech_fetch_one('select count(1) as num from categories;')['num'];

// $comments_count = tech_fetch_one('select count(1) as num from comments;')['num'];

$posts_count = '111';

$categories_count = '222';
